          ...
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            {showModal && (
              <div className="fixed inset-0 flex justify-center items-center  bg-black/40 z-50">
                <div className="bg-white p-3 max-w-xl w-full relative rounded-2xl">
                  <button
                    onClick={modalClose}
                    className="absolute top-4 right-4 flex justify-center items-center text-4xl text-red-500 hover:bg-white w-7 h-7 hover:rounded-full"
                  >
                    {" "}
                    &times;{" "}
                  </button>
                  <iframe className="w-full aspect-auto rounded-2xl"
                    width="560"
                    height="315"
